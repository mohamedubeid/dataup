...
@section('content')
    ...
    <section class="margin-page">
        <section class="hero-section" data-aos="zoom-in">
            <div class="container">
                <div class="newsletter-box">
                    ...
                    <button class="to-next-sec-btn-style" id="scrollToNext">
        ...
        {{-- About Section --}}
        <section id="about-section" class="about-dataup-section">
            <div class="container">
        ...
        <section class="contact-us-section">
            <div class="container">
                ...
                <p class="fs-5 mb-4 pb-2"  data-aos="fade-down">{{ __('main.contact_message')}}</p>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const nextSection = document.querySelector('.why-choose-us-style'); // Adjust this selector
        if (nextSection) {
